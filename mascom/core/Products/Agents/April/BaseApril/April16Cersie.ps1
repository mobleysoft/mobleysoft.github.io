...
"@
        ...
        # Write scene to file
        Write-OutputAndConsole -Message ($SceneContent + "`n`n") -OutputFile $OutputFile
...
"@
    ...
    $AllScenePrompts = Generate-AllScenePrompts -TotalChapters $TotalChapters -DetailedChapterOutline $DetailedChapterOutline -Title $Title -WorldBible $WorldBible
    ...
    Generate-NarrativeContent -AllScenePrompts $AllScenePrompts -WorldBible $WorldBible -OutputFile $OutputFile
