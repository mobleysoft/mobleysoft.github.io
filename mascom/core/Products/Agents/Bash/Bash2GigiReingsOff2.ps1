...
for ($i = 0; $i -lt $Paragraphs.Count; $i += $ParagraphsPerImage) {
    ...
    $IllustrationPrompt = "A warm, colorful children's book illustration featuring the events of the following text, set in an expressive and painterly style: ${TextSegment}"
